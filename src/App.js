...
import  MessageSendingStatement  from './components/MessageSendingStatement';
...
const Chat = () => {
  ...
  return (
    <div>
      <input type="text" value={jsonInput} onChange={e => setJsonInput(e.target.value)} placeholder="Message" />
        ...
        >
          {messages.map((msg, index) => (
            <div className="list-item">
              <ListItem>
                <MessageSendingStatement  message={msg.sendJsonMessage}/>
